...
$aLang = array(
    ...
    'FCPO_HELP_BONIVERSUM_BASIC_ADDRESSCHECK'   => 'Check the address on existence and supplementing and correcting the address (Possible for addresses in Germany, Austria, Switzerland, Netherlands, Belgium, Luxembourg, France, Italy, Spain, Portugal, Denmark, Sweden, Finland, Norway, Poland, Slovakia, Czech Republic, Hungary, U.S., Canada)',
    'FCPO_HELP_BONIVERSUM_PERSON_ADDRESSCHECK'  => 'Check whether the person is known by the specified address, check the address on existence and supplementing and correcting the address (only Germany)',
    ...
    'fcpo_receivable_appointed2'                => 'Demand (Authorization)',
    ...
    'FCPO_HELP_REDUCE_STOCK'                    => 'This configuration only has effect when "Save order before authorization" is activated and the customer is redirected to an external paymentservice ( i.e. Sofort, PayPal or creditcard with 3D Secure ). This configuration defines if the stock for the articles is reduced before or after the redirect to the external paymentservice.',
    ...
    'FCPO_AMAZONPAY_GET_CONFIG'                 => 'Receive Amazon-Configuration from Payone',
    'FCPO_AMAZONPAY_ERROR_GETTING_CONFIG'       => 'There has been a problem with calling your configuration from Payone API. You will find further information under Payone Logs->API Logs.',
    'FCPO_AMAZONPAY_SUCCESS_GETTING_CONFIG'     => 'Amazon configuration has been successfully received',
    'FCPO_AMAZONPAY_BUTTON_TYPE'                => 'Amazon Button Type',
    'FCPO_AMAZONPAY_BUTTON_TYPE_PwA'            => 'Amazon Pay (Default)',
    'FCPO_AMAZONPAY_BUTTON_TYPE_Pay'            => 'Pay (Slightly smaller)',
    'FCPO_AMAZONPAY_BUTTON_TYPE_A'              => 'Amazon Logo (Small)',
    'FCPO_AMAZONPAY_BUTTON_COLOR'               => 'Amazon Buttoncolor',
    'FCPO_AMAZONPAY_BUTTON_COLOR_GOLD'          => 'Gold (Default)',
    'FCPO_AMAZONPAY_BUTTON_TYPE_LIGHT_GRAY'     => 'Light gray',
    'FCPO_AMAZONPAY_BUTTON_TYPE_DARKGRAY'       => 'Dark gray',
    'FCPO_AMAZONPAY_BUTTON_LANG'                => 'Language of the Amazon Button',
    'FCPO_AMAZONPAY_BUTTON_LANG_NONE'           => 'Autodetect',
    ...
    'FCPO_AMAZONPAY_BUTTON_LANG_ITALIAN_ITALY'  => 'Italien (Italy)',
    ...
    'FCPO_ADDRESSCHECK_PNP' => 'If address can not be checked due to an incorrect name, user is returned to the user form',
    'FCPO_ADDRESSCHECK_PUG' => 'If building is not known user will be returned to the user form',
    'FCPO_ADDRESSCHECK_PUZ' => 'If person has moved the user will be redirected to user form',
    'FCPO_ADDRESSCHECK_UKN' => 'If values are unknown, users are returned to the user form',
    'fcpo_admin_config_error_iframe_mapping' => 'Own error messages for Hosted iFrame',
    'fcpo_admin_config_payone_error_code' => 'Error ID',
    'fcpo_admin_config_payone_error_message' => 'Payone Error Message',
    'fcpo_admin_config_status_language' => 'Language',
    'fcpo_admin_config_status_own_error_message' => 'Your own error message',
    'FCPO_CAPTURE_AMOUNT_GREATER_NULL' => 'The amount for a capture must be higher than 0.00!',
    'fcpo_clearingtype_fcpocommerzfinanz' => 'Commerz Finanz',
    'fcpo_clearingtype_fcpoklarna_install' => 'Klarna Installment',
    'FCPO_CONFIG_DEBIT_BANKDATA' => 'Entry of bank data',
    'FCPO_CONFIG_DEBIT_GER' => 'Only with German accounts',
    'FCPO_CONFIG_DEBIT_MANDATE' => 'Mandate process',
    'FCPO_CONFIG_DEBIT_MANDATE_ACTIVE' => 'mandate process active',
    ...
    'FCPO_CONFIG_DEBIT_MANDATE_DOWNLOAD_TEXT' => 'This option is only available, if you booked the<br>PAYONE product "SEPA-Mandate as PDF"',
    'FCPO_CONFIG_DEBIT_MANDATE_TEXT' => 'The mandate process is done by using the payable request "managemandate".<br>This request includes a bankaccountcheck. However, here no query is possible for the POS lock list.',
    'FCPO_CONFIG_DEBIT_MULTISELECT' => 'List of supported countries.<br>Hold CTRL key down for multiple highlighting.',
    'FCPO_CONFIG_DEBIT_SHOW_OLD_FIELDS' => 'also display the account number / bank code',
    'FCPO_CONFIG_GROUP_PAYOLUTION' => 'Payolution',
    'FCPO_CONFIG_GROUP_RATEPAY' => 'Ratepay',
    'FCPO_HELP_ASSIGNCOUNTRIES_2' => 'If no countries are assigned, the payment applies to all countries. <br> If countries are assigned, the payment applies only to these countries. <br> Billing country and destination country weill be tested.',
    'FCPO_HELP_ASSIGNCOUNTRIES_3' => 'If no countries are assigned, the payment applies to all countries. <br> If countries are assigned, the payment applies only to these countries. <br> Billing country and destination country weill be tested.',
    'FCPO_HELP_MALUS' => 'The configured deductions are subtracted from the creditworthiness value of the customer according to the return value of the address check. The credit rating can not be less than 0.',
    ...
    'FCPO_HELP_RATEPAY_B2BMODE' => 'When the B2B mode is activated and the company name specified by the user, the VAT ID no. is requested. For B2C customers the date of birth is requested instead.',
    'FCPO_HELP_SAVEBANKDATA' => 'As it is standard in OXID, the bank account is stored encrypted for the Payone payment type direct debit and is ready for the customer\'s next purchase.',
    'FCPO_KLARNA_ADD_CAMPAIGN' => 'Add campaign',
    'FCPO_KLARNA_CAMPAIGNS' => 'Campaign',
    'FCPO_KLARNA_CAMPAIGN_CODE' => 'Code of campaign',
    'FCPO_KLARNA_CAMPAIGN_TITLE' => 'Title',
    'FCPO_MALUS' => 'Deduction',
    'FCPO_MALUSHANDLING' => 'Person status deduction handling',
    'FCPO_MALUS_PAB' => 'First and last name unknown',
    'FCPO_MALUS_PHB' => 'Last name known',
    'FCPO_MALUS_PKI' => 'Ambiguity in name and address',
    'FCPO_MALUS_PNZ' => 'Can not be delivered',
    'FCPO_MALUS_PPB' => 'Person can be confirmed for this address',
    'FCPO_MALUS_PPF' => 'Details of the postal address are incorrect',
    'FCPO_MALUS_PPV' => 'Person died',
    'FCPO_PAYOLUTION_AUTH_SECRET' => 'Payolution password',
    'FCPO_PAYOLUTION_AUTH_USER' => 'Payolution user name',
    'FCPO_PAYOLUTION_B2BMODE' => 'Run Payolution in B2B mode',
    'FCPO_PAYOLUTION_COMPANY' => 'Company name',
    'FCPO_PAYOLUTION_MODE' => 'Run Payolution in test mode',
    'FCPO_PERSONSTATUS' => 'Person status',
    'FCPO_PREAUTHORIZED_AMOUNT' => 'Preauthorized amount',
    ...
    'FCPO_SAVEBANKDATA' => 'Storage of bank data',
    'FCPO_SHOW_SOFO_IBAN_FIELDS' => 'Show IBAN/BIC fields',
