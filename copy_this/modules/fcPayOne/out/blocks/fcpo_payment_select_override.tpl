...
[{elseif $sPaymentID == "fcpo_ideal"}]
    ...
    [{include file=$oViewConf->fcpoGetAbsModuleTemplateFrontendPath($sFcPoTemplatePath)}]
[{elseif in_array($sPaymentID, array('fcpopo_debitnote', 'fcpopo_bill', 'fcpopo_installment'))}]
    [{assign var="sFcPoTemplatePath" value=$sFcPoTemplatePath|cat:'/fcpo_payment_payolution.tpl'}]
    [{include file=$oViewConf->fcpoGetAbsModuleTemplateFrontendPath($sFcPoTemplatePath)}]
