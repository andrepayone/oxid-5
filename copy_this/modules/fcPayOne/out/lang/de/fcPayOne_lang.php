...
$aLang = array(
    ...
    'FCPO_PAYOLUTION_PLEASE SELECT'                 => 'Bitte w�hlen...',
    ...
    'FCPO_PAYOLUTION_AGREEMENT_PART_1'              => 'Mit der �bermittlung der f�r die Abwicklung des Rechnungskaufes und einer Identit�tspr�fung und Bonit�tspr�fung erforderlicher Daten an Payolution GmbH, Columbusplatz 7-8, 1120 Wien bin ich einverstanden.<br>Meine',
    ...
    'FCPO_PAYOLUTION_PHONE_MISSING'                 => 'Die Angabe der Telefonnummer wird ben�tigt.',
    ...
    'FCPO_AMAZON_SELECT_ADDRESS'                    => 'Adresse aus dem Amazon-Adressbuch ausw�hlen',
    'FCPO_AMAZON_SELECT_PAYMENT'                    => 'Zahlungsart aus der Amazon-Brieftasche ausw�hlen',
    'FCPO_AMAZON_LOGOFF'                            => 'Den Amazon Pay Bestellprozess beenden und zur�ck zum Standard-Checkout',
    'FCPO_AMAZON_PROBLEM'                           => 'Es gibt ein Problem',
    'FCPO_AMAZON_NO_SHIPPING_TO_COUNTRY'            => 'F�r das Land Ihrer angegebene Adresse existiert keine Versandm�glichkeit. Bitte klicken Sie <a href="index.php?cl=user" style="color:green;">hier</a> um zur Adressauswahl zur�ckzukehren.',
    'FCPO_AMAZON_THANKYOU_MESSAGE'                  => 'Ihre Zahlung mit Amazon Pay ist derzeit noch in Pr�fung.Bitte beachten Sie, dass wir uns mit Ihnen in K�rze per Email in Verbindung setzen werden, falls noch Unklarheiten bestehen sollten.',
    'FCPO_AMAZON_ERROR_TRANSACTION_TIMED_OUT'       => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_INVALID_PAYMENT_METHOD'      => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte �berpr�fen Sie Ihre Daten und w�hlen Sie eine anderen Zahlungsart.',
    'FCPO_AMAZON_ERROR_REJECTED'                    => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PROCESSING_FAILURE'          => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_BUYER_EQUALS_SELLER'         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PAYMENT_NOT_ALLOWED'         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PAYMENT_PLAN_NOT_SET'        => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_SHIPPING_ADDRESS_NOT_SET'    => 'Bitte w�hlen Sie eine Adresse.',
    'FCPO_AMAZON_ERROR_900'                         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte w�hlen Sie eine andere Zahlart.',
