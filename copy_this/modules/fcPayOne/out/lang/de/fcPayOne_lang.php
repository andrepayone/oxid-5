...
$aLang = array(
    ...
    'FCPO_CC_DATE_INVALID'                          => 'Bitte geben Sie ein korrektes Gï¿½ltigkeits-Datum an.',
    'FCPO_CC_CVC2_INVALID'                          => 'Bitte geben Sie eine korrekte Prï¿½fziffer an.',
    'fcpo_so_ktonr'                                 => 'Kontonummer:',
    'fcpo_so_blz'                                   => 'BLZ:',
    'FCPO_MANIPULATION'                             => 'Verdacht auf Manipulation',
    'FCPO_REMARK_APPOINTED_MISSING'                 => 'Der Shop hat den Transaktionsstatus APPOINTED nicht erhalten. Bitte prï¿½fen Sie diese Bezahlung sorgfï¿½ltig!',
    ...
    'FCPO_ADDRESSCHECK_FAILED2'                     => '"<br>Bitte ï¿½berprï¿½fen Sie Ihre Eingaben.<br>Wenn die Daten dennoch korrekt sind kontaktieren Sie bitte den Kundendienst.',
    ...
    'FCPO_ADDRESSCHECK_UKN'                         => 'Unbekannte Rï¿½ckgabewerte',
    'FCPO_ADDRESSCHECK_PUG'                         => 'Adresse postalisch korrekt aber Gebï¿½ude ist unbekannt',
    'FCPO_ADDRESSCHECK_PNZ'                         => 'Kann nicht mehr beliefert werden',
    'FCPO_ADDRESSCHECK_PNP'                         => 'Adresse kann nicht geprï¿½ft werden. Ein falscher Name wurde benutzt',
    ...
    'FCPO_BANK_GER_OLD'                             => 'oder bezahlen Sie wie gewohnt mit Ihren bekannten Kontodaten<br>(nur fï¿½r Deutsche Kontoverbindungen).',
    ...
    'FCPO_VALID_UNTIL'                              => "Gï¿½ltig bis:",
    'FCPO_CARD_SECURITY_CODE'                       => "Prï¿½fziffer:",
    'FCPO_CARD_SECURITY_CODE_DESCRIPTION'           => "Diese befindet sich auf der Rï¿½ckseite Ihrer Kreditkarte. Die Prï¿½fziffer<br>sind die letzten drei Ziffern im Unterschriftsfeld.",
    'FCPO_TYPE_OF_PAYMENT'                          => "Zahlungsart",
    'FCPO_MIN_ORDER_PRICE'                          => "Mindestbestellwert",
    'FCPO_PREVIOUS_STEP'                            => "Zurï¿½ck",
    'FCPO_CONTINUE_TO_NEXT_STEP'                    => "Weiter zum nï¿½chsten Schritt",
    'FCPO_PAYMENT_INFORMATION'                      => "Bezahlinformation",
    'FCPO_PAGE_CHECKOUT_PAYMENT_EMPTY_TEXT'         => '<p>Derzeit ist keine Versandart fï¿½r dieses Land definiert.</p> <p>Wir werden versuchen, Liefermï¿½glichkeiten zu finden und Sie ï¿½ber die Versandkosten informieren.</p>',
    ...
    'FCPO_KLV_CONFIRM'                              => 'Mit der ï¿½bermittlung der fï¿½r die Abwicklung der gewï¿½hlten Klarna Zahlungsmethode und einer Identitï¿½ts- und Bonitï¿½tsprï¿½fung erforderlichen Daten an Klarna bin ich einverstanden. Meine <a target="_blank" style="text-decoration: underline;" href="https://cdn.klarna.com/1.0/shared/content/legal/terms/%s/%s/consent">Einwilligung</a> kann ich jederzeit mit Wirkung fï¿½r die Zukunft widerrufen. Es gelten die AGB des Hï¿½ndlers.<br><br>Weitere Informationen zum Rechnungskauf finden Sie in den <a target="_blank" style="text-decoration: underline;" href="https://cdn.klarna.com/1.0/shared/content/legal/terms/%s/%s/invoice?fee=0">Rechnungsbedingungen</a>.',
    ...
    'FCPO_KLV_ADDINFO_INVALID'                      => 'Bitte fï¿½llen Sie das Feld aus.',
    'FCPO_KLV_ADDINFO_DEL'                          => 'Zus. Info Lieferadresse',
    'FCPO_KLV_SAL'                                  => 'Anrede',
    'FCPO_KLV_PERSONALID'                           => 'Personenkennziffer',
    'FCPO_KLV_PERSONALID_INVALID'                   => 'Bitte fï¿½llen Sie das Feld aus.',
    'FCPO_KLV_INFO_NEEDED'                          => 'Um den Kauf mit Klarna Rechnung durchfï¿½hren zu kï¿½nnen, benï¿½tigen wir noch ein paar Angaben von Ihnen.',
    'FCPO_KLV_CONFIRMATION_MISSING'                 => 'Sie mï¿½ssen noch Ihr Einverstï¿½ndnis mit der ï¿½bermittlung der Daten erklï¿½ren.',
    ...
    'FCPO_ORDER_MANDATE_INFOTEXT'                   => 'Damit wir die SEPA-Lastschrift von Ihrem Konto einziehen kï¿½nnen, benï¿½tigen wir von Ihnen ein SEPA-Lastschriftmandat.',
    'FCPO_ORDER_MANDATE_CHECKBOX'                   => 'Ich mï¿½chte das Mandat erteilen<br>(elektronische ï¿½bermittlung)',
    'FCPO_ORDER_MANDATE_ERROR'                      => 'Sie mï¿½ssen das SEPA-Lastschriftmandat bestï¿½tigen.',

    'FCPO_THANKYOU_PDF_LINK'                        => 'Ihr SEPA-Mandat als PDF',
    'FCPO_MANAGEMANDATE_ERROR'                      => 'Es ist ein Problem aufgetreten. Bitte ï¿½berprï¿½fen Sie Ihre Eingaben oder wï¿½hlen Sie eine andere Zahlart.',

    'FCPO_PAYPALEXPRESS_USER_SECURITY_ERROR'        => 'Bitte loggen Sie sich im Shop ein und fï¿½hren Sie den PayPal Express Checkout nochmal durch. Ihre PayPal-Lieferadresse stimmt nicht mit den im Shop hinterlegten Adressdaten &uuml;berein.',
    ...
    'FCPO_PAYOLUTION_PRECHECK_FAILED'               => 'Die Transaktion wurde vom Finanzierungs-Dienstleister abgelehnt. Bitte wï¿½hlen Sie eine andere Zahlart',
    'FCPO_PAYOLUTION_PLEASE SELECT'                 => 'Bitte wï¿½hlen...',
    ...
    'FCPO_PAYOLUTION_AGREEMENT_PART_1'              => 'Mit der ï¿½bermittlung der fï¿½r die Abwicklung des Rechnungskaufes und einer Identitï¿½tsprï¿½fung und Bonitï¿½tsprï¿½fung erforderlicher Daten an Payolution GmbH, Columbusplatz 7-8, 1120 Wien bin ich einverstanden.<br>Meine',
    'FCPO_PAYOLUTION_AGREEMENT_PART_2'              => 'kann ich jederzeit mit Wirkung fï¿½r die Zukunft wiederrufen.',
    'FCPO_PAYOLUTION_AGREE'                         => 'Einwilligung',
    'FCPO_PAYOLUTION_EMAIL_CLEARING'                => 'Payolution Referenzcode:',
    'FCPO_PAYOLUTION_NOT_AGREED'                    => 'Sie haben die Einwilligung zur ï¿½bertragung der erforderlichen Daten an payolution nicht bestï¿½tigt.',
    'FCPO_PAYOLUTION_SEPA_NOT_AGREED'               => 'Sie haben das SEPA Lastschriftmandat noch nicht erteilt.',
    'FCPO_PAYOLUTION_PHONE_MISSING'                 => 'Die Angabe der Telefonnummer wird benï¿½tigt.',
    ...
    'FCPO_BANK_IBAN'                                => 'IBAN',
    'FCPO_BANK_BIC'                                 => 'BIC',
    'FCPO_PAYOLUTION_BANKDATA_INCOMPLETE'           => 'Ihre eingebenen Kontodaten sind nicht vollstï¿½ndig.',
    'FCPO_PAYOLUTION_CHECK_INSTALLMENT_AVAILABILITY'=> 'Verfï¿½gbarkeit prï¿½fen',
    'FCPO_PAYOLUTION_INSTALLMENT_SELECTION'         => 'Ratenkaufoptionen',
    'FCPO_PAYOLUTION_SELECT_INSTALLMENT'            => 'Bitte wï¿½hlen Sie eine Ratenoption aus',
    'FCPO_PAYOLUTION_INSTALLMENT_SUMMARY_AND_ACCOUNT'=> 'ï¿½bersicht und Kontoinformationen',
    'FCPO_PAYOLUTION_PLEASE_CHECK_AVAILABLILITY'    => 'Bitte prï¿½fen Sie zunï¿½chst die Verfï¿½gbarkeit der mï¿½glichen Ratenzahlungsoptionen',
    ...
    'FCPO_PAYOLUTION_INSTALLMENTS_NUMBER'           => 'Anzahl Raten',
    ...
    'FCPO_PAYOLUTION_NO_INSTALLMENT_SELECTED'       => 'Sie haben keine Ratenkaufoption ausgewï¿½hlt',
    ...
    'FCPO_RATEPAY_NO_SUFFICIENT_DATA'               => 'Es fehlen einige persï¿½nliche Angaben zu Ihrer Person. Bitte fï¿½llen Sie die eingeblendeten Felder aus.',
    'FCPO_AMAZON_SELECT_ADDRESS'                    => 'Adresse aus dem Amazon-Adressbuch auswï¿½hlen',
    'FCPO_AMAZON_SELECT_PAYMENT'                    => 'Zahlungsart aus der Amazon-Brieftasche auswï¿½hlen',
    'FCPO_AMAZON_LOGOFF'                            => 'Den Amazon Pay Bestellprozess beenden und zurï¿½ck zum Standard-Checkout',
    'FCPO_AMAZON_PROBLEM'                           => 'Es gibt ein Problem',
    'FCPO_AMAZON_NO_SHIPPING_TO_COUNTRY'            => 'Fï¿½r das Land Ihrer angegebene Adresse existiert keine Versandmï¿½glichkeit. Bitte klicken Sie <a href="index.php?cl=user" style="color:green;">hier</a> um zur Adressauswahl zurï¿½ckzukehren.',
    'FCPO_AMAZON_THANKYOU_MESSAGE'                  => 'Ihre Zahlung mit Amazon Pay ist derzeit noch in Prï¿½fung.Bitte beachten Sie, dass wir uns mit Ihnen in Kï¿½rze per Email in Verbindung setzen werden, falls noch Unklarheiten bestehen sollten.',
    'FCPO_AMAZON_ERROR_TRANSACTION_TIMED_OUT'       => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_INVALID_PAYMENT_METHOD'      => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte ï¿½berprï¿½fen Sie Ihre Daten und wï¿½hlen Sie eine anderen Zahlungsart.',
    'FCPO_AMAZON_ERROR_REJECTED'                    => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PROCESSING_FAILURE'          => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_BUYER_EQUALS_SELLER'         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PAYMENT_NOT_ALLOWED'         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_PAYMENT_PLAN_NOT_SET'        => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
    'FCPO_AMAZON_ERROR_SHIPPING_ADDRESS_NOT_SET'    => 'Bitte wï¿½hlen Sie eine Adresse.',
    'FCPO_AMAZON_ERROR_900'                         => 'Entschuldigung, die Transaktion mit Amazon Pay war nicht erfolgreich. Bitte wï¿½hlen Sie eine andere Zahlart.',
