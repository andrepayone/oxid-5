...
$aLang = array(
    ...
    'FCPO_ADDRESSCHECK_PUG'                     => 'If building is unknown user will get redirected to user form',
    'FCPO_ADDRESSCHECK_PUZ'                     => 'If person has moved user will get redirected to user form',
    'FCPO_ADDRESSCHECK_UKN'                     => 'If values are unknown user will get redirected to user form',
    'FCPO_ADDRESSCHECK_PNP'                     => 'If address is unchackable because of a wrong name user will get redirected to user form',
    'FCPO_SAVEBANKDATA'                         => 'Store bank account data',
    'FCPO_CONFIG_DEBIT_SHOW_OLD_FIELDS'         => "Provide account and bank number fields in addition",
    ...
    'FCPO_SHOW_IBAN_FIELDS' => 'Show IBAN/BIC fields',
    ...
    'FCPO_MALUSHANDLING'                        => 'Personal status deduction',
    'FCPO_PERSONSTATUS'                        	=> 'Personal status',
    'FCPO_MALUS'                        		=> 'Deduction',
    'FCPO_MALUS_PPB'                            => 'Person does not match address',
    'FCPO_MALUS_PHB'                            => 'Last name found',
    'FCPO_MALUS_PAB'                            => 'First and last name unknown',
    'FCPO_MALUS_PKI'                            => 'Ambigious address',
    'FCPO_MALUS_PNZ'                            => 'Can not be delivered',
    'FCPO_MALUS_PPV'                            => 'Deceased',
    'FCPO_MALUS_PPF'                            => 'Address elements are incorrect',
    'FCPO_HELP_MALUS'                           => 'Creditworthiness cannot reach value below 0. Defined values will get deducted from creditwothiness score.',
    ...
    'FCPO_PAYOLUTION_B2BMODE'                   => 'Run Unzer in B2B mode',
    'FCPO_PAYOLUTION_COMPANY'                   => 'Company name',
    'FCPO_PAYOLUTION_MODE'                      => 'Run Unzer in test mode',
