<dl>
    ...
    <dd class="[{if  $oView->fcpoIsKlarnaCombined($checkedPaymentId)}]activePayment[{/if}]">
        ...
        <div class="col-lg-offset-3 form-group" style="padding-bottom: 30px">
            <label for="klarna_payment_selector" class="req control-label col-lg-3">[{oxmultilang ident="PAYMENT_METHOD"}]</label>
            <div class="col-lg-9">
        ...
        <div class="alert alert-info col-lg-12 desc">
        ...
        <div id="klarna_combined_js_inject" class="col-lg-9"></div>

        <div id="klarna_widget_combined_container" class="col-lg-9"></div>
