...
class fcporatepay extends oxBase {
     ...
     * @return mixed
     */
    protected function _fcpoGetProfilePaymentActiveField($sPaymentId) {
        $aMap = array(
            'fcporp_bill' => 'activation_status_invoice',
        );
        
        $mReturn = false;
        if (isset($aMap[$sPaymentId])) {
            $mReturn = $aMap[$sPaymentId];
        }
