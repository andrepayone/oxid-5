...
class fcpayone_main extends fcpayone_admindetails {
    ...
    public function autoconfigsave() {
        ...
        $this->save();
        $aResponse = $oFcpoRequest->sendRequestGetPayoneMerchantSetup();
    ...
    /**
     * Activate payone payments which are available by given platform-configuration
     *
     * @param $aConfig
     */
    ...
    /**
     * Checks if button for fetching configuration settings fopr amazon from payone api has been triggered
